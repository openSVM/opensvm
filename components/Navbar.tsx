        ...
        <div className="flex h-16 justify-between">
          <div className="flex">
            <div className="flex flex-shrink-0 items-center">
              <span className="text-[20px] font-bold text-gray-900">OPENSVM</span>
            </div>
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              <a
                href="#"
                className="inline-flex items-center border-b-2 border-[#00ffbd] px-1 pt-1 text-[13px] font-medium text-gray-900"
              >
                Home
              </a>
              <a
                href="#"
                className="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-[13px] font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700"
              >
                Tokens
              </a>
              <a
